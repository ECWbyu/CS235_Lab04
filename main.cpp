...
int main() {
    ...
    cout << "Default array: " << qsptr->getArray() << endl;
    cout << "Creating array of capacity 20..." << endl;
    qsptr->createArray(20);
    cout << "New array: " << qsptr->getArray() << endl;
    cout << "Adding 16 random items to the array..." << endl;
    for (int i = 16; i > 0; i--) {
        //qsptr->addToArray(rand() % 100);
        qsptr->addToArray(i);
    }
    cout << "New array: " << qsptr->getArray() << endl;
    cout << "medianOfThree(0, 15) returns: " << qsptr->medianOfThree(0, 15) << endl;
    cout << "New array: " << qsptr->getArray() << endl;
    cout << "partition(0, 15, 8) returns: " << qsptr->partition(0, 15, 8) << endl;
    cout << "New array: " << qsptr->getArray() << endl;
...
const std::string fileArray[NUM_FILES] = { "CheckFiles/file1.txt", "CheckFiles/file2.txt", "CheckFiles/file3.txt", "CheckFiles/file4.txt", "CheckFiles/file5.txt" }; // the string array containing the file names
